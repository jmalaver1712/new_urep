...
<body id="body_urep">
  ...
  <div class="breadcrumb"><a href="index.php"> Inicio </a> > <a href="index.php"> Expo - Estudiantes </a></div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m6">
          ...
          <!-- <iframe src="https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2FURepublicanaRadio%2Fvideos%2F10150936880239996%2F&show_text=0&width=560" style="border:none;overflow:hidden" width="100%" class="video"></iframe> -->
          ...
          <div class="icon-block">
            ...
            <div class="input-field col s12">
              <select name="programa" id="programa" required>
                ...
                <option value="2">Contaduría pública</option>
                ...
                <option value="5">Finanzas y comercio internacional</option>
              </select>
              <label>Programa de Interes</label>
            </div>

            <div class="input-field col s12">
              <input type="checkbox" id="terminos_cond" name="terminos_cond" required="" value="si"/>
              <label for="terminos_cond">
                He leido y acepto los terminos y condiciones. <a href="#">Términos y condiciones (Habeas Data)</a>
              </label>
            </div>
            <div class="input-field col s12">
              <input type="checkbox" id="informacion" name="informacion" value="si"/>
              <label for="informacion">Acepto recibir más información del programa de interés</label>
